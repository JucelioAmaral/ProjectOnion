...
namespace ProjectOnion.Infra.Data.Repositories
{
    public class CourseRepository : ICourse
    {
        ...
        public CourseRepository(IConfiguration conf) => conexao = new SqlConnection("Data Source=127.0.0.1;Initial Catalog=DatabaseProjectOnion;Persist Security Info=True;User ID=tmds;Password=tmds");
